        ...
        <div className='d-flex row flex-wrap align-items-top'>
            <div className='col-md-4 mb-3 bg-light p-2 align-items-center justify-content-center'>
                ...
                <table className='container-fluid d-flex align-items-center border border-3 border-info mb-4 rounded p-3'>
                    <tbody>
                        <tr>
                            <td className='row flex-nowrap'><div><img src={student.image} className='student_search_image row flex-nowrap' alt='Image Missing'/></div></td>
                ...
                <div className="mt-3">
                    ...
                    <tbody>
                            ...
                            <tr >
                                ...
                                <p className='text-danger'>{c.industry_supervisor_comment || ''}</p>
                                <textarea
                                type="text"
                                rows="2"
